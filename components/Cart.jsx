...
const Cart = ({ setCartModal }) => {
  ...
  return (
    <motion.div 
      className="w-full flex flex-col md:w-1/2 lg:w-1/4 bg-white border-4 border-black fixed top-[-1.5rem] right-0 lg:right-0 lg:top-[-25px] lg:left-[unset] h-screen z-[1000]"
