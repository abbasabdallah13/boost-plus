    ...
    <Carousel 
      ...
      className="shadow-lg mt-5">
        <div className="flex items-center p-2 sm:gap-4 sm:p-4 md:justify-around">
          <Image src={sliderImg1} className="w-40 h-40 sm:w-46 sm:h-46 md:w-56 md:h-56" alt='slider img 1'   />
        ...
        <div className="flex flex-col p-4 gap-2">
          <div className="flex items-center justify-between md:justify-around">
            <h1 className="text-xl font-bold text-center md:mb-10">Snabb leverans inom 5 min-24 timmar</h1>
            <Image src={sliderImg3} className='w-32 h-24 md:w-56 md:h-48 md:relative'   alt='slider Img3' />
          </div>
          <div>
            <p className="text-sm text-center md:w-1/3 md:relative md:bottom-20 md:left-20">Vårt system levererar automatiskt alla tjänster inom 5 minuter till 24 timmar. Oavsett vilken tid du beställer.</p>
          </div>          
        </div>
