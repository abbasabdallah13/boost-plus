...
function CheckoutUserDetails({ setPaymentMethodModal }) {
  ...
  return (
    <div>
        ...
        <form className="md:flex md:flex-wrap md:justify-between" onSubmit={validateUserInfo}>
            <div className="flex flex-col md:w-[48%] xl:w-[31%]">
                <label className="font-zen-kaku font-semibold text-base text-gray-600 mt-2 mb-[2px]" htmlFor="first name">First Name</label>
            ...
            <div className="flex flex-col md:w-[48%] xl:w-[31%]">
                <label className="font-zen-kaku font-semibold text-base text-gray-600 mt-2 mb-[2px]" htmlFor="last name">Last Name</label>
            ...
            <div className="flex flex-col md:w-[48%] xl:w-[31%]">
                <label className="font-zen-kaku font-semibold text-base text-gray-600 mt-2 mb-[2px]" htmlFor="email">Email</label>
            ...
            <div className="flex flex-col md:w-[48%] xl:w-[31%]">
                <label className="font-zen-kaku font-semibold text-base text-gray-600 mt-2 mb-[2px]" htmlFor="mobile">Mobile Number (include + and country code)</label>
            ...
            <div className="flex flex-col md:w-[48%] xl:w-[31%]">
                <label className="font-zen-kaku font-semibold text-base text-gray-600 mt-2 mb-[2px]" htmlFor="country">Country</label>
                <Select 
            ...
            <div className="flex flex-col md:w-[48%] xl:w-[31%]">
                <label className="font-zen-kaku font-semibold text-base text-gray-600 mt-2 mb-[2px]" htmlFor="town">Town or City</label>
