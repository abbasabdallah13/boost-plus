...
const DashboardLogin = () => {
  ...
  return (
    <section className="mt-0 flex flex-col items-center justify-center h-fit h-screen bg-slate-600">
        <div className="z-20 bg-white opacity-70 flex flex-col p-4 w-4/5 max-w-[320px] rounded-md">   
            ...
            <div className="flex justify-center">
                <button onClick={() => login()}  className="rounded-full mt-2 w-10 h-10 text-4xl flex items-center justify-center hover:text-[#8a8a8a]"><AiOutlineLogin  /></button>
            </div>
        </div>
    </section>
  )
